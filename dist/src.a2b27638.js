...
function createInputsEventListeners(inputs) {
  ...
  var bottomInput = inputs[1];
  var inputTopValue = [];
  var inputBottomValue = [];
...
function findInputs() {
  ...
  var bottomInput = inputs.find(function (element) {
    return element.classList.contains("amount_bottom");
  });
  var bottomSelect = inputs.find(function (element) {
    return element.classList.contains("select_bottom");
  });
  specificInputs.push(topInput, bottomInput);
  specificSelects.push(topSelect, bottomSelect); // console.log(specificSelects, specificInputs);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            // waiting to give a chance to find inputs after 'open' and 'open-active' transfer to new panel
            findInputs();
